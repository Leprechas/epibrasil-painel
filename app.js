...
async function loadPopulation(){
  try{
    ...
    for(const r of rows){
      ...
      const municipioRaw=String(r.municipio_ibge||r.municipio||"").trim();
...
function renderMunicipalTable(rows){
  ...
  $("table").innerHTML="<thead><tr><th>UF</th><th>Código</th><th>Município</th><th>Casos no período</th><th>População-ano</th><th>Incidência</th><th>Pop. estimada</th></tr></thead><tbody>"+
